...
- *Install*
  ...
  + antigen - =master= branch\\
    =curl -L git.io/antigen > antigen.zsh=

  + zplugin - =dev= branch(replace antigen)\\
...
** 3.2 Plugins.
*Plugin Manager*
- [[https://github.com/zsh-users/antigen][Antigen]] - will Deprecated.
- [[https://github.com/zdharma/zplugin][Zplugin]] - =dev=
