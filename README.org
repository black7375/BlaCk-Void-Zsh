...
* 3. Info.
** 3.1 Theme.
- [[https://github.com/bhilburn/powerlevel9k][Powerlevel9k]](will Deprecated)
- [[https://github.com/romkatv/powerlevel10k][Powerlevel10k]](Really Fast and 100% replaceable, =dev= branch)
- [[https://github.com/sindresorhus/pure][Pure]](simple theme, =dev= branch)
